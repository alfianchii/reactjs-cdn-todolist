			...
			<div className="col">
				<div className="text-center mb-3">
					...
					<span className="mb-3 mt-2 d-inline-block h6 font-monospace font-weight-light text-muted">
						...
						by{" "}
						<a href="https://github.com/alfianchii" className="text-decoration-none" target="_blank">
							Alfian
						</a>
					</span>
				</div>
						...
						<>
							{todos.map((todo, index) => (
								<tr key={todo.id}>
									...
									<td className="align-middle">{todo.done ? <span className="badge text-bg-success">Done</span> : <span className="badge text-bg-warning">Progress</span>}</td>
									<td className="align-middle">
